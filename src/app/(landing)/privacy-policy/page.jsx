            ...
            <section className="max-w-5xl mx-auto px-6 py-20 text-gray-800">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">
                        <span>Privacy <span className="text-[#F97316]">Policy</span></span>
                    ...
                    <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                        Your privacy matters to us. Learn how PixelMuse collects, protects, and uses your
                ...
                <div className="space-y-10 text-lg leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-semibold text-[#F97316] mb-3">
                            1. Introduction
                        </h2>
                        <p>
                            Welcome to <strong>PixelMuse</strong> — a modern blog focused on arts and design. This Privacy Policy explains how we handle your personal
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            <li>Publish relevant articles in art & design.</li>
                    ...
                    <section>
                        ...
                        <p>
                            At PixelMuse, we take your data security seriously. We use encryption and secure
                    ...
                    <section>
                        ...
                        <p>
                            PixelMuse uses Google AdSense to display advertisements. Google may use
