      ...
      <>
        <div className="font-sans bg-background text-foreground min-h-screen relative">
            ...
            <div className="max-w-3xl mx-auto flex flex-col items-center justify-center h-[80vh] text-center px-4">
                ...
                <a
                    href="/"
                    className="mt-6 px-5 py-2 rounded-md border border-gray-300 dark:border-[#F97316] text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-[#F97316] transition-colors duration-200"
                >
                    ← Back to Home
                </a>
            </div>
