...
export default function ContactPageContent() {
    ...
    try {
      await emailjs.send(
        ...
        "template_pnu9ter", // Template ID
        {
          ...
          to_name: "YieldWitness Team (PixelMuse Website)",
  ...
  return (
    <>
        ...
        <section className="relative flex items-center justify-center min-h-screen py-20 px-6 bg-[#EEF3F7]">
        ...
        <div className="max-w-2xl w-full bg-white border border-gray-200 rounded-2xl shadow-md p-8">
            ...
            <div>
                ...
                required
                className="w-full px-4 py-3 rounded-lg bg-white border border-gray-300 text-gray-900 focus:ring-2 focus:ring-[#F97316] outline-none transition"
                />
            </div>
            ...
            <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 bg-[#F97316] text-white font-semibold text-lg rounded-lg shadow-md hover:bg-[#0D8C8B] focus:ring-2 focus:ring-[#F97316]/60 disabled:opacity-60 transition-all"
            >
